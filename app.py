...
with col2:
    ...
    st.write("AI Powered Breast Cancer Diagnosis Platform")
...
if analyze:
    ...
    suggestions = {
        "Mean Radius": round(radius*0.9,2),
        "Mean Texture": round(texture*0.9,2),
        "Mean Perimeter": round(perimeter*0.9,2),
        "Mean Area": round(area*0.9,2),
        "Mean Concave Points": round(concave*0.9,3)
    }
