...
if analyze:
    ...
    # LOGO
    try:
        pdf.image("logo.png",15,15,20)
    except:
        pass

    # TITLE
    pdf.set_font("Arial","B",16)
    pdf.cell(0,10,"NAP HOSPITAL DIAGNOSTIC REPORT",0,1,"C")
    ...
    pdf.cell(0,6,f"Report Generated: {now}",0,1,"R")
    ...
    pdf.set_font("Arial","",11)
    pdf.cell(0,6,f"Confidence Level: {confidence:.2f}%",0,1,"C")
